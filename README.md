...
| [`java/test_sonar`](java/test_sonar/action.yml) | Same as `java/test` plus SonarCloud analysis (`./gradlew build sonar`) |

See [java/README.md](java/README.md) for workflow samples and Gradle configuration.
